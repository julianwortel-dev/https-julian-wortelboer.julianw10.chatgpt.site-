  ...
  return (
    <main className="insights-page">
      ...
      <header className="site-header">
        ...
        <nav aria-label="Insights navigation"><a href="/">Home</a><a href="/#expertise">Expertise</a><a href="/#work">Work</a><a href="/padel-coach-certification">Coach Certification</a><a href="/padel-club-growth-roadmap">Club Roadmap</a><a className="nav-cta" href="/contact">Work with Julian <ArrowRight size={16} /></a></nav>
