...
export default function CoachingPage() {
  ...
  return <main className="coaching-page">
    ...
    <header className="site-header">
      ...
      <nav aria-label="Coaching navigation"><a href="/"><ArrowLeft size={16} /> Home</a><a href="#methodology">Methodology</a><a href="#coaching-options">Coaching options</a><a href="/padel-club-growth-roadmap">Club Roadmap</a><a href="/insights#coaching">Insights</a><a className="nav-cta" href={whatsappUrl} target="_blank" rel="noreferrer">Request a session <ArrowDownRight size={16} /></a></nav>
    ...
    <footer><div className="brand footer-wordmark"><img className="wordmark" src="/assets/julian-wordmark-transparent.webp" alt="Julian Wortelboer" /></div><p>Padel Master Coach · Miami · USA</p><div><a href="/">Home</a><a href="/padel-club-growth-roadmap">Club Roadmap</a><a href="/insights">Insights</a><a href="https://www.instagram.com/julianwortelboer/" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.youtube.com/@padelsmashtv" target="_blank" rel="noreferrer">YouTube</a></div></footer>
  </main>;
}
