...
const projects = [
  ...
  { name: 'Wynwood Padel Club', place: 'Miami, Florida', number: '05', note: 'Program Director & Academy Developer', url: 'https://www.wynwoodpadelmiami.com/' },
    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          <a href="#expertise">Expertise</a><a href="#work">Work</a><a href="/padel-coaching-miami">Coaching</a><a href="/padel-coach-certification">Coach Certification</a><a href="/padel-club-growth-roadmap">Club Roadmap</a><a href="#about">About</a><a href="/insights">Insights</a>
