...
try {
  ...
  const feedUpdated = new Date(Math.max(...articles.map(article => new Date((article.updatedDate || article.date) + ' 12:00:00 UTC').getTime()))).toUTCString();
